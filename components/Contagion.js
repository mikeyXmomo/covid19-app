	...
	return (
		<div tw="w-full h-auto flex justify-center">
			<div tw="w-4/5 flex flex-col justify-center items-center">
				...
				<div tw="flex flex-row justify-between items-center py-5">
					<div tw="w-1/3 h-auto flex flex-col border-b-4 justify-center items-center shadow-2xl mx-4 p-8 transition duration-500 ease-in-out transform hover:-translate-y-2 hover:border-red-999 hover:scale-110">
